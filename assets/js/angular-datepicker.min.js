    ...
    , datepickerDirective = function datepickerDirective($window, $compile, $locale, $filter, $interpolate) {
      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        var selector = attr.selector
          ...
          , thisTrigger= angular.element(input ? element[0].querySelector('.' + input) : element[0].children[0])
          , theCalendar
          ...
          , restoreSelectedDate = function restoreSelectedDate () {
              var dateToRestore = $scope.dateSet;
              
              if (dateToRestore !== 'false') {

                date = new Date(dateToRestore);
          ...
          // , unregisterDataSetWatcher = $scope.$watch('dateSet', function dateSetWatcher(newValue, oldValue) {
        ...
        thisTrigger.on('click', function onFocusAndClick() {
